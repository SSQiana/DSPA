...
parser.add_argument(
    "--gen_ratio", type=float, default=0.01, help="the ratio of mixing samples"
)
...
parser.add_argument(
    "--alpha", type=float, default=0.9, help="parameter of constrastive loss"
)
parser.add_argument("--beta", type=float, default=0.01, help="parameter of ecvae")
parser.add_argument("--clf_layers", type=int, default=1, help="clf_layers")
parser.add_argument("--pe", type=float, default=0.8, help="perturbation rate")
parser.add_argument('--k', type=int, default=3, help="number of augmentation branches")
parser.add_argument("--arg_lr1", type=float, default=100, help="Augmentation learning rate")
parser.add_argument("--aug_iter", type=float, default=15, help="Augmentation iteration")
parser.add_argument('--num_runs', type=int, default=3, help="Number of runs")

parser.add_argument('--max_epoch', type=int, default=200, help="number of augmentation branches")
